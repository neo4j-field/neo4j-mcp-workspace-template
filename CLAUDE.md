...
Six MCP servers are configured for this workspace:
...
### `neo4j-cypher`
- **Purpose:** Execute read/write Cypher queries against Neo4j
- **Key tools:** `read_neo4j_cypher`, `write_neo4j_cypher`
- **Required env:** `NEO4J_URI`, `NEO4J_USERNAME`, `NEO4J_PASSWORD`, `NEO4J_DATABASE`
- **Source:** `uvx mcp-neo4j-cypher@0.5.3`
...
- **Required env:** `NEO4J_URI`, `NEO4J_USERNAME`, `NEO4J_PASSWORD`, `NEO4J_DATABASE`, `OPENAI_API_KEY`, `EMBEDDING_MODEL`
...
- **Required env:** `NEO4J_URI`, `NEO4J_USERNAME`, `NEO4J_PASSWORD`, `NEO4J_DATABASE`, `OPENAI_API_KEY`, `EXTRACTION_MODEL`
...
- **Required env:** `NEO4J_URI`, `NEO4J_USERNAME`, `NEO4J_PASSWORD`, `NEO4J_DATABASE`, `OPENAI_API_KEY`, `EMBEDDING_MODEL`
- **Source:** `uvx mcp-neo4j-graphrag@0.3.0`
...
| 4 | Generate Cypher for use cases | `neo4j-cypher` |
| 5 | Query via vector/fulltext/graph search | `neo4j-graphrag` |
| 6 | Validate graph addresses use cases | `neo4j-cypher` |
