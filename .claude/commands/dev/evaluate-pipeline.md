...
> **Internal use only.** Run this after completing a `/build-pdf-chatbot` or `/develop-neo4j-graph` run to evaluate how well the skill and MCP tools performed. Produces a structured report to guide improvement of skills and server tools.
