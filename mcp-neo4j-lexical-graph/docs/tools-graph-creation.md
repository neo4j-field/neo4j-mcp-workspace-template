...
| `parse_mode` | No | `"pymupdf"` | `"pymupdf"`, `"docling"`, or `"page_image"` |
...
| `skip_furniture` | No | `true` | Skip headers/footers (docling mode) |
| `extract_sections` | No | `true` | Extract section hierarchy (docling mode) |
